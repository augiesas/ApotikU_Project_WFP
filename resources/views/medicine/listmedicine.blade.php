                    ...
                    <form method="POST" action="{{ route('medicine.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="form" placeholder="Enter Formula"
                                        name="form" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="restriction_form"
                                        placeholder="Enter Restriction Formula" name="restriction_form" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" id="price" placeholder="Enter Price (Rp)"
                                        name="price" required>
                                </div>
                            </div>
